    ...
    <>
      ...
      <div className="container-fluid">
        <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li className="nav-item" role="presentation"> <button className="py-1 px-2 small  nav-link active" id="pills-whatIsSHA256-tab" data-toggle="pill" data-target="#pills-whatIsSHA256"  type="button" role="tab" aria-controls="pills-whatIsSHA256" aria-selected="false" >What is SHA256</button> </li>
