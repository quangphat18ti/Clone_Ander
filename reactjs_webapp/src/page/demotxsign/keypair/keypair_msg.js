...
export default function KeypairMessage() {
    ...
    <>
      <form>
        <div className="form-group mx-4 mt-3">
          <label className="form-message" htmlFor="message"> <strong>Key Text</strong></label>
          <input className="form-control" id     ="message" type="text" placeholder="Enter your key text to generate private key" value={message || ''} 
        ...
        <div className="form-group mx-4">
          ...
          <small className="form-text text-muted"> 
            Private Key is SHA256(Key Text) 
          </small>
        </div>
