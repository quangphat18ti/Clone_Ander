    ...
    <>
      <form>
        <div className="form-group mx-4">
          <label className="form-message" htmlFor="message"> <strong>Message</strong></label>
          <input className="form-control" id     ="message" type="text" placeholder="Enter your message to generate private key" value={message || ''} 
